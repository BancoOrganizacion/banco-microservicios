...
export class UsersClientService {
    ...
    async onModuleInit() {
        try {
            ...
            this.logger.error(`Error al conectar con el microservicio de usuarios: ${error.message}`);
        }
    }
    ...
    async findByUsername(username: string) {
        ...
        try {
            ...
            this.logger.error(`Error al buscar usuario por username: ${error.message}`);
            throw error;
        }
    }
