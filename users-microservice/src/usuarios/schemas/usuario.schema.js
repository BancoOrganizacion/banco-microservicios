...
exports.CuentaAppSchema = exports.CuentaApp = exports.UsuarioSchema = exports.Usuario = void 0;
...
__decorate([
    (0, mongoose_1.Prop)({ required: true, unique: true }),
    __metadata("design:type", String)
], CuentaApp.prototype, "nombre_usuario", void 0);
__decorate([
    (0, mongoose_1.Prop)({ required: true }),
    __metadata("design:type", String)
], CuentaApp.prototype, "contrase\u00F1a", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        type: mongoose_2.Schema.Types.ObjectId,
        ref: 'Usuario',
